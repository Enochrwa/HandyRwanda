    ...
    >
      <View className="w-12 h-12 rounded-full bg-primary/10 items-center justify-center">
        {item.other_user.avatar_url ? (
          <Image source={{ uri: item.other_user.avatar_url }} className="w-full h-full rounded-full" />
        ) : (
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View className="items-center justify-center mt-20">
            <Text className="text-muted-foreground text-center">No messages yet.{'\n'}Book an artisan to start chatting.</Text>
          </View>
        }
      />
    </View>
