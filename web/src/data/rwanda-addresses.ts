 ...
 * Bundled directly so the address picker works fully offline on 2G/3G.
 *
 * Structure: { [province]: { [district]: { [sector]: string[] /* cells/villages */

export type RwandaData = {
  [province: string]: {
    [district: string]: {
      [sector: string]: string[]; // cells (leaf level for mobile; villages are free-text)
    };
  };
};
