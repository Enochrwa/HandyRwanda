  ...
  return (
    <div className="min-h-screen bg-muted/30 pb-12">
      ...
      <main className="mx-auto max-w-4xl px-4 pt-12">
        ...
        <p className="text-muted-foreground mt-2">Showcase your best work to attract more clients.</p>
        ...
        <div className="mt-10 grid grid-cols-2 md:grid-cols-3 gap-6">
          ...
          {[1, 2, 3].map((i) => (
            <div key={i} className="group relative aspect-square rounded-3xl overflow-hidden bg-muted">
              <img
