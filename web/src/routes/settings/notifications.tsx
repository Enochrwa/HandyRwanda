...
const PREF_LABELS: { key: keyof Prefs; label: string; description: string }[] = [
  {
    key: "new_bid",
    label: "New bids",
    description: "When an artisan places a bid on your job",
  },
  {
    key: "booking_update",
    label: "Booking updates",
    description: "Confirmations, completions, and status changes",
  },
  {
    key: "payment",
    label: "Payments & earnings",
    description: "Payment approvals, escrow releases, withdrawals",
  },
...
function NotificationPreferencesPage() {
  ...
  const { data: serverPrefs } = useQuery<Prefs>({
    ...
    queryFn: () => api.get("/notifications/preferences").then((r) => r.data as Prefs),
  });
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-10">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Choose what to receive</CardTitle>
        </CardHeader>
